...
date: today
date-format: long
abstract: "Marriage can be one of the best days in a person's life, but it can be a hassle getting all family members together. So, people choose specific times to make sure some of their relatives can make it. So we wanted to know if summer marriages are more popular in Toronto because maybe people are more likely to take time off. We found that this is not the case. Marriages seem to be pretty evenly common across months in Toronto, but maybe that isn’t true in other parts of the world."
format: pdf
...
marriage_data %>% ggplot(aes(x = month, y = marriages, fill=is_summer_month)) +
  ...
  labs(title = "Marriages by Month in Toronto (2000-2023)", 
       ...
       caption = "Summer months do not appear to have more marriges") + 
  theme_minimal()
